                                        ...
                                        <div class="col-6">
                                            <div class="card border-0 bg-light">
                                                <div class="card-body">
                                                    ...
                                                    <h5 class="mb-0">${this.productRenderer.formatPrice(shoe.base_price)}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="card border-0 bg-light">
                                                <div class="card-body">
                                                    ...
                                                    <h5 class="mb-0">${category?.category_name || 'N/A'}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="card border-0 bg-light">
                                                <div class="card-body">
                                                    ...
                                                    <h5 class="mb-0">
                                                        <span class="badge ${
                                                            totalStock > 20 ? 'bg-success' :
                                                            totalStock > 0 ? 'bg-warning' : 'bg-danger'
                                                        } fs-5">
                                                            ${totalStock} units
                                                        </span>
                                                    </h5>
                                        ...
                                        <div class="col-6">
                                            <div class="card border-0 bg-light">
                                                <div class="card-body">
                                                    ...
                                                    <h5 class="mb-0">${variants.length}</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>    
